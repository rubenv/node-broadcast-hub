...
Client = (function() {
  ...
  Client.prototype.onConnect = function(data, cb) {
    return this.hub.canConnect(this, data, (function(_this) {
  ...
  Client.prototype.onSubscribe = function(name, cb) {
    ...
    return this.hub.canSubscribe(this, name, (function(_this) {
      return function(err, allowed) {
        if (err) {
          return cb(err);
        }
        ...
        return Channel.get(_this.hub, name, function(err, channel) {
          if (err) {
            return cb(err);
          }
